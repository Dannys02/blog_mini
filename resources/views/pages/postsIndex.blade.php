...
<body class="bg-light-bg text-dark-text min-h-screen p-8 lg:p-12 font-sans">
  ...
  <div class="max-w-6xl mx-auto">
    ...
    <div class="flex w-full mb-2">
      <a href="/create" class="px-4 py-1 text-white text-center rounded-xl bg-blue-600">
        + Buat
      </a>
    </div>
          ...
          <tbody class="divide-y divide-gray-200">
            ...
            <tr>
              ...
              <td class="px-6 py-4 whitespace-nowrap text-sm font-medium flex items-center space-x-2">
                <a href="/post/show/{{ $p->id }}" class="inline-flex justify-center items-center px-3 py-1 text-sm font-medium text-white bg-blue-500 hover:bg-indigo-700 rounded-full transition duration-150 shadow-md">
                  Detail
                </a>
                <a href="/post/edit/{{ $p->id }}" class="inline-flex justify-center items-center px-3 py-1 text-sm font-medium text-white bg-yellow-500 hover:bg-yellow-600 rounded-full transition duration-150 shadow-md">
                  Edit
                </a>
                <form action="/post/delete/{{ $p->id }}" method="post" class="inline">
                  @csrf
                  @method('DELETE')
