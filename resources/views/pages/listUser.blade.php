  ...
  <div class="flex-1 flex flex-col overflow-hidden">
    ...
    <main class="flex-1 overflow-x-hidden overflow-y-auto bg-gray-50 p-4 md:p-8">
      ...
      <div class="bg-white p-6 rounded-xl shadow-2xl border border-gray-100">
        ...
        @php
        $users = [
        ['name' => 'Dannys Martha F', 'email' => 'danz@gmail.com', 'registered_at' => '2023-10-15 08:30:00'],
        ['name' => 'Joebiden lighning', 'email' => 'joo@gmail.com', 'registered_at' => '2023-11-01 12:00:00'],
        ['name' => 'akbar samiden', 'email' => 'den@gmail.com', 'registered_at' => '2023-12-05 15:45:00'],
        ['name' => 'Siti Kholil', 'email' => 'sisi@gmail.com', 'registered_at' => '2024-01-20 09:10:00'],
        ];
        @endphp

        @foreach ($users as $user)
        <div class="user-card bg-gray-50 p-4 rounded-lg border border-gray-200 mb-4 transition duration-300 hover:shadow-md hover:border-indigo-300 md:grid md:grid-cols-6 md:gap-4 md:items-center">

          <div class="col-span-1 flex items-center space-x-3 mb-2 md:mb-0">
            <div class="w-10 h-10 flex items-center justify-center text-lg font-bold text-white bg-indigo-500 rounded-full flex-shrink-0 shadow-md">
          ...
          <div class="col-span-1 text-left md:text-right">
            @php
            $date = \Carbon\Carbon::parse($user['registered_at']);
            @endphp
            <p class="text-xs text-gray-500 md:hidden">
              Daftar :
            </p>
